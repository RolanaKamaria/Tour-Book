        ...
        <div className=" w-full h-screen max-h-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="container flex flex-row items-center relative pt-52 ">
                    ...
                    <div className="bg-presenterbg-light text-center text-text-light absolute   drop-shadow-[2px_2px_rgba(211,168,76,0.6)]  xl:rounded xl:left-80 xl:top-48 xl:w-56 xl:h-10 lg:rounded-md lg:left-72 lg:top-48 lg:w-48 lg:h-8 md:rounded-sm md:left-64 md:top-48 md:w-44 md:h-8 ">
...
export default PresenterNewPassword
