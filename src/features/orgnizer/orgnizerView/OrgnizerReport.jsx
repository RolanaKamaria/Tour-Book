    ...
    return (
        <div className=" w-full h-screen max-h-full">
            ...
            <div className="container flex flex-row items-center relative xl:pt-24 lg:pt-32 md:pt-32">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        md:text-lg md:my-20">
                            ...
                            xl:gap-x-24 lg:gap-2 md:gap-2">
                                <span className="w-52">Presnter Name :</span>
                                <span className="font-['BlinkMacSystemFont'] ">{state.reports.respondentUser}</span>
                            </div>
                            <div className="flex flex-row justify-between 
                            xl:gap-x-24 lg:gap-2 md:gap-2">
                                <span className="w-52">Presenter Email :</span>
                                <span className="font-['BlinkMacSystemFont']">{state.reports.respondentEmail}</span>
                            </div>
                ...
                md:rounded-sm md:left-64  md:w-28 md:h-8 md:top-28 ">
